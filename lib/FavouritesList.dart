...
class FavouritesList extends StatefulWidget {
  FavouritesList({
    ...
    this.handleSide = FavouriteSide.Right,
    this.handleIcon,
    this.padding,
  });
  ...
  final FavouriteSide handleSide;
  ...
  @override
  State<FavouritesList> createState() => new _ReorderableListSimpleState();
}

class _ReorderableListSimpleState extends State<FavouritesList> {
  int _newIndex;
  ...
  @override
  didUpdateWidget(FavouritesList oldWidget) {
...
class ReorderableItemSimple extends StatelessWidget {
  ...
  Widget _buildInnerItem(BuildContext context) {
    ...
    if (handleSide == FavouriteSide.Right) children.add(item);
    ...
    if (handleSide == FavouriteSide.Left) children.add(item);

    final Row row = Row(
      mainAxisAlignment: handleSide == FavouriteSide.Right ? MainAxisAlignment.end : MainAxisAlignment.start,
